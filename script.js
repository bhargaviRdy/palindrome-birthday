...
var gif = document.querySelector("#gif_image");
...
function clickHandler(e) {
    ...
    if (bdayString !== "") {
        ...
        if (!isPalindrome) {
            ...
            if (ctr1 > ctr2) {
                resultDiv.innerText = `The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} day/s.`;
            } else {
                resultDiv.innerText = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} day/s.`;
            }
        } else {
...
showBtn.addEventListener("click", (e) => {
    if(bdayInput.value.length < 1){
        error.innerText = "Enter the date";
        resultDiv.innerText = "";
    }
    else{
        error.innerText = "";
        gif.setAttribute("src", "numbers-crushing.gif");
        resultDiv.innerText = "";
        setTimeout(
            function () {
